...
class ZHHivisionParamsNode:
    ...
    RETURN_TYPES = ("PARAMS", "INT", "INT",)
    RETURN_NAMES = ("normal_params", "width", "height",)
    ...
    def get_params(self, size, bgcolor, render, kb, dpi, custom_width, custom_height):
        if render == "纯色":
            render = "pure_color"
        elif render == "上下渐变":
        ...
        if custom_width > 0 and custom_height > 0:
            save_size = (custom_height, custom_width)
        else:
            save_size = size_list_dict_CN[size]
        parmas = {
            "size": save_size,
...
NODE_CLASS_MAPPINGS = {
    "zhiyou-LaterProcessNode": LaterProcessNode,
    "zhiyou-HivisionNode": HivisionNode,
    "zhiyou-ZHHivisionParamsNode": ZHHivisionParamsNode,
    "zhiyou-ENHivisionParamsNode": ENHivisionParamsNode,
    "zhiyou-AddWaterMarkNode": AddWaterMarkNode,
    "zhiyou-AddBackgroundNode": AddBackgroundNode,
    "zhiyou-HivisionLayOutNode": HivisionLayOutNode,
}
